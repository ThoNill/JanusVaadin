...
public abstract class VaadinBasisConnector implements PropertyChangeListener,
	...
	private static final Logger LOG = LogManager.getLogger(VaadinBasisConnector.class);
	...
	protected Vector<GuiComponent> childComponents = null;
	...
	public void addComponent(GuiComponent comp) {
		...
		/*
		 * TODO if (comp instanceof ContextMenuConnector) { ContextMenuConnector
		 * popup = (ContextMenuConnector) comp; ContextMenu popupMenu =
		 * popup.getMenu(); getControl().setContextMenu(popupMenu); }
		 */
		...
		/*
		 * TODO if (comp instanceof ContextMenuConnector) { if (component
		 * instanceof Control) { getControl().setContextMenu(
		 * ((ContextMenuConnector) comp).getMenu()); } } else {
		 */
