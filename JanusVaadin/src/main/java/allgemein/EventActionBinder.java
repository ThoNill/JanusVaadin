...
public class EventActionBinder {
    ...
    protected void registerMouseEvent(Component node) {
        if (mouseEvent != null) {
             ...
             * node.addListener( new
             * com.vaadin.event.MouseEvents.ClickListener() {
             * 
             * @Override public void
             * click(com.vaadin.event.MouseEvents.ClickEvent event) {
             * System.out.println("Mouse click"); doAction(); }
             * 
             * 
             ...
             * 
             * @Override public void
             * doubleClick(com.vaadin.event.MouseEvents.DoubleClickEvent event)
             * { System.out.println("Mouse click"); doAction(); }
             * 
             * 
             * }); }
    ...
    protected void registerKeyEvent(Component node) {
         ...
         * if (keyEvent != null) {
         * 
         * node.setOnKeyPressed(new EventHandler<KeyEvent>() { public void
         * handle(KeyEvent ke) { if
         * (keyEvent.getKeyEvent().equals(ke.getCode())) { switch
         * (keyEvent.getMask()) { case InputEvent.CTRL_MASK: if
         * (ke.isControlDown()) { doAction(); } break; case
         * InputEvent.SHIFT_MASK: if (ke.isShiftDown()) { doAction(); } break;
         * default: doAction(); break; } } } }); }
         */
    }
    ...
    protected void doAction() {
        ...
        CentralActionPerformingQueue.performAction(action, context);
    }
